...
String myAPI = "3711f1116334241e9dc4b85458c72d29";


const char* units = "metric";                   // User: Set your units to "metric" or "imperial" here
const char* wifiSSID = "Miris Wetter Station";  // User: Set your WiFi SSID here
const char* wifiPassword = "password";          // User: Set your WiFi password here
